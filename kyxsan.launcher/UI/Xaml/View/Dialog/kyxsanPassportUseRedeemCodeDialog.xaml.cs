...
internal sealed partial class kyxsanPassportUseRedeemCodeDialog : ContentDialog
{
    private readonly IContentDialogFactory contentDialogFactory;

    [GeneratedConstructor(InitializeComponent = true)]
    public partial kyxsanPassportUseRedeemCodeDialog(IServiceProvider serviceProvider);
