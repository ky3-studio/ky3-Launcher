...
[SuppressMessage("", "SH001", Justification = "IkyxsanDiagnostics must be public in order to be exposed to the scripting environment")]
public interface IkyxsanDiagnostics
{
