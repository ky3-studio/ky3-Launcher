...
internal sealed class LauncherException : Exception
{
    ...
    public static LauncherException Throw(string message, Exception? innerException = default)
    {
        throw new LauncherException(message, innerException);
    }
    ...
    [DoesNotReturn]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static LauncherException GachaStatisticsInvalidItemId(uint id, Exception? innerException = default)
    {
        throw new LauncherException(SH.FormatServiceGachaStatisticsFactoryItemIdInvalid(id), innerException);
    }
