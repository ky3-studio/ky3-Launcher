...
internal sealed class ShellLinkInterop : IShellLinkInterop
{
    ...
    {
        string targetLogoPath = LauncherRuntime.GetDataSubDirectoryFile("Assets", "ShellLinkLogo.ico");
        ...
        try
        {
            ...
            // InstalledLocation.CopyFileFromApplicationUri("ms-appx:///Launcher.Elevated.Launcher.exe", elevatedLauncherPath);
