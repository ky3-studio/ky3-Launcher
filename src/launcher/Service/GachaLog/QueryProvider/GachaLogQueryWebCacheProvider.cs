...
namespace Launcher.Service.GachaLog.QueryProvider;
...
internal sealed partial class GachaLogQueryWebCacheProvider : IGachaLogQueryProvider
{
    ...
    {
        return MatchUrlFromCacheStream(stream, isOversea);
    }

    internal static unsafe string? MatchUrlFromCacheStream(MemoryStream stream, bool isOversea)
    {
