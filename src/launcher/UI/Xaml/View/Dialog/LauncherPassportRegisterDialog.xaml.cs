...
internal sealed partial class LauncherPassportRegisterDialog : ContentDialog
{
    ...
    public partial LauncherPassportRegisterDialog(IServiceProvider serviceProvider);
    ...
    {
        SentrySdk.AddBreadcrumb(BreadcrumbFactory.CreateUI("Verify", "LauncherPassportRegisterDialog.Command"));
        ...
        using (IServiceScope scope = serviceScopeFactory.CreateScope())
        {
            ...
            LauncherResponse response = await LauncherPassportClient.RequestVerifyAsync(UserName, VerifyCodeRequestType.Registration).ConfigureAwait(false);
