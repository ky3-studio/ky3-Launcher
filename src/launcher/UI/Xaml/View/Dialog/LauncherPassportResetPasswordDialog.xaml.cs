...
internal sealed partial class LauncherPassportResetPasswordDialog : ContentDialog
{
    ...
    public partial LauncherPassportResetPasswordDialog(IServiceProvider serviceProvider);
    ...
    {
        SentrySdk.AddBreadcrumb(BreadcrumbFactory.CreateUI("Verify", "LauncherPassportResetPasswordDialog.Command"));
        ...
        using (IServiceScope scope = serviceScopeFactory.CreateScope())
        {
            ...
            LauncherResponse response = await LauncherPassportClient.RequestVerifyAsync(UserName, VerifyCodeRequestType.ResetPassword).ConfigureAwait(false);
