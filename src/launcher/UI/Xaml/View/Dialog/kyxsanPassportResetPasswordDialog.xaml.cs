...
internal sealed partial class kyxsanPassportResetPasswordDialog : ContentDialog
{
    ...
    public partial kyxsanPassportResetPasswordDialog(IServiceProvider serviceProvider);
    ...
    {
        SentrySdk.AddBreadcrumb(BreadcrumbFactory.CreateUI("Verify", "kyxsanPassportResetPasswordDialog.Command"));
        ...
        using (IServiceScope scope = serviceScopeFactory.CreateScope())
        {
            ...
            kyxsanResponse response = await kyxsanPassportClient.RequestVerifyAsync(UserName, VerifyCodeRequestType.ResetPassword).ConfigureAwait(false);
