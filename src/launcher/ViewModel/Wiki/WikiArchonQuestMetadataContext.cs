...
internal sealed class WikiArchonQuestMetadataContext : IMetadataContext,
    IMetadataArrayArchonQuestSource
{
    public ImmutableArray<ArchonQuest> ArchonQuests { get; set; } = default!;
}
