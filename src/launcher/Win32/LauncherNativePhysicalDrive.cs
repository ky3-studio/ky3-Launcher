...
internal sealed unsafe class LauncherNativePhysicalDrive
{
    private readonly ObjectReference<Vftbl> objRef;

    public LauncherNativePhysicalDrive(ObjectReference<Vftbl> objRef)
    {
        this.objRef = objRef;
    }
    ...
    [Guid(LauncherNativeMethods.IID_ILauncherNativePhysicalDrive)]
