...
internal sealed unsafe class LauncherNativeProcess
{
    private readonly ObjectReference<Vftbl> objRef;

    public LauncherNativeProcess(ObjectReference<Vftbl> objRef)
    {
        this.objRef = objRef;
    }
    ...
    [Guid(LauncherNativeMethods.IID_ILauncherNativeProcess)]
